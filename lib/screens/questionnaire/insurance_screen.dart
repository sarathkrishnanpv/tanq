        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => _buildUploadItem(
              fileName: controller.insurancePaths.isNotEmpty ? controller.insurancePaths.first.split('/').last : '',
              fileSize: '1.5 MB',
            ...
            SizedBox(
              ...
              child: Obx(() => ElevatedButton(
                onPressed: controller.insurancePaths.isNotEmpty ? () {
                  controller.insuranceUploaded.value = true;
                  Get.back();
                } : null,
                style: ElevatedButton.styleFrom(
                  backgroundColor: controller.insurancePaths.isNotEmpty ? Colors.black : Colors.grey[300],

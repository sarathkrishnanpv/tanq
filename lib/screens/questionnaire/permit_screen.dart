        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => _buildUploadItem(
              fileName: controller.permitPaths.isNotEmpty ? controller.permitPaths.first.split('/').last : '',
              fileSize: '1.0 MB',
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem(
                  value: 'State',
                  child: Text('State Permit'),
                ),
                DropdownMenuItem(
                  value: 'National',
                  child: Text('National Permit'),
                ),
                DropdownMenuItem(
                  value: 'Tourist',
                  child: Text('Tourist Permit'),
                ),
              ],
              onChanged: (value) {
                // Update the permit type in the controller
              },
            ),
            SizedBox(height: 16.h),
            ...
            SizedBox(
              ...
              child: Obx(() => ElevatedButton(
                onPressed: controller.permitPaths.isNotEmpty ? () {
                  controller.permitUploaded.value = true;
                  Get.back();
                } : null,
                style: ElevatedButton.styleFrom(
                  backgroundColor: controller.permitPaths.isNotEmpty ? Colors.black : Colors.grey[300],

        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => _buildUploadItem(
              fileName: controller.pollutionPaths.isNotEmpty ? controller.pollutionPaths.first.split('/').last : '',
              fileSize: '1.1 MB',
            ...
            SizedBox(
              ...
              child: Obx(() => ElevatedButton(
                onPressed: controller.pollutionPaths.isNotEmpty ? () {
                  controller.pollutionUploaded.value = true;
                  Get.back();
                } : null,
                style: ElevatedButton.styleFrom(
                  backgroundColor: controller.pollutionPaths.isNotEmpty ? Colors.black : Colors.grey[300],
